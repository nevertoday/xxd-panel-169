...
# XXD Panel 169｜رسم صغير بالحبر والمغرة الدافئة
...
ثمانية نماذج أولية من Panel 169، وُلّد كل منها مستقلاً من صورة مصدر مختلفة مع نص إنجليزي قصير. الأفقي: 1536×864 بنصفين متساويين يميناً ويساراً؛ العمودي: 1152×1536 بنصفين متساويين أعلى وأسفل.

رُوجعت الورقة البيضاء الدافئة والرسوم الحبرية المعزولة ومطابقة المصدر لكل نموذج. يظهر الأزرق في 06 و09، وتبقى تفاصيل منظر كثيرة في 07 و12، وخطوط 08 سميكة وكرتونية. بعض الرسوم أو النصوص كبيرة. لا تتحقق باستمرار شروط الألوان المحدودة والخطوط الدقيقة والفراغ بنسبة 75–85%. هذه نتائج أولية وليست نماذج أسلوب معتمدة جميعها.
...
75–85% ورق أبيض دافئ غير مرسوم و15–25% رسم صغير معزول، بخطوط حبر رفيعة ومغرة وكاكي ولمسات برتقال محروق.
...
- `design-only`: تعرض اللوحة الكاملة ترجمة Panel 169 التصميمية فقط، وتبقى الصورة مرجعاً غير ظاهر.
...
بعد التثبيت أعد تشغيل جلسة Agent ثم استدعِ `$xxd-panel-169`. ويمكن إضافة `--global --agent codex --yes` للتثبيت على مستوى المستخدم.

```text
/xxd-panel-169 photo.jpg --mode top-bottom --size 3:4 --text prompt --locale ar-SA
...
راجع [SKILL.md](SKILL.md) لعقد التشغيل الكامل، ومهايئ التشغيل [بالإنجليزية](references/xxd-panel-169-prompt.en.md) أو [بالصينية](references/xxd-panel-169-prompt.zh-CN.md).
